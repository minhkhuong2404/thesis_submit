    ...
    class IncrementalDataset(parent_class):
        ...
        def generate_seen_tasks(self, model, batch_size, seen_dataset_size, writer, save_path,
            ...
            if openset:
                ...
                print("seen_dataset_size")
                print(int(seen_dataset_size))
                print("openset_tailsize")
                print(int(openset_tailsize))
                print("len(self.seen_tasks)")
                print(int(len(self.seen_tasks)))
                print("self.num_increment_tasks)")
                print(int(self.num_increment_tasks))
